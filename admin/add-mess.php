...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        <form action="add-mess.php" method="post" style="margin:3%;padding:3%" id="mess-form"name="mess-form" enctype="multipart/form-data" >
 ...
 advance,number_seat,image,others,image_kitchen,image_washroom,area,email)
  VALUES('$name','$mobile','$area','$address','$date','$description','$cost',
