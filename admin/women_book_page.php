...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
  ...
  <div class="form-group">
    <label for="exampleFormControlFile1">National Id Card Image</label>
